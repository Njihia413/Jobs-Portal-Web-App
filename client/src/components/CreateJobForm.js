                        ...
                        <div className="row">
                            ...
                            <div className="col-md-6">
                                <div className="form-group">
                                    ...
                                    <select name="category" id="category" className="form-select" aria-label="Default select example" value={category} onChange={(e) => setCategory(e.target.value)}  required>
                            ...
                            <div className="col-md-6">
                                <div className="form-group">
                                    ...
                                    <select name="job_type" id="job_type" className="form-select" aria-label="Default select example" value={jobType} onChange={(e) => setJobType(e.target.value)} >
                            ...
                            <div className="col-md-12">
                                <div className="form-group">
                                    <button type="submit" className="btn btn-post-job">{isLoading ? "Loading..." : "Post Job"}</button>
                                </div>
                            </div>
